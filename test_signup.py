...
class TestSignup():
  ...
  def test_signup(self):
    ...
    self.driver.find_element(By.ID, "lastName").send_keys("Testinggg")
    self.driver.find_element(By.ID, "password1").click()
    self.driver.find_element(By.ID, "password1").send_keys("Test@2023")
    self.driver.find_element(By.ID, "password2").click()
    self.driver.find_element(By.ID, "password2").send_keys("Test@2023")
    self.driver.find_element(By.ID, "chefAccount").click()
